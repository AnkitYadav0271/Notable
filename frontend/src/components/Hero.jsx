          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            {
              <h1 className="font-bold text-2xl">
                Welcome {user ? user?.username : "Please Login to get started"}
              </h1>
            }
            ...
            <div className="space-x-4">
              <Button
                onClick={() => {
                  user ? navigate("/create-todo") : navigate("/login");
                }}
                size="lg"
                className="h-12 px-8 relative bg-green-600 hover:bg-green-500 cursor-pointer"
              >
                Start Taking Notes
              ...
              <Button
                variant="outline"
                size="lg"
                className="h-12 px-8 bg-white text-green-800 cursor-pointer"
              >
                Watch Demo
              </Button>
            </div>
